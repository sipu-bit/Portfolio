        ...
        <div className="w-full flex flex-col justify-center h-[80vh]">
            <div className="flex flex-col gap-4">
              ...
              <AOSWrapper duration={1200} easing="ease-out" once={true}><div data-aos="fade-up" className=""><Heading1 text="Based in Bhubaneswar,Odisha" className="text-4xl" /></div></AOSWrapper> 
                   ...
                   <AOSWrapper duration={1200} easing="ease-out" once={true}> <p
  data-aos="fade-up"
  className="leading-8 text-md text-justify"
  style={{ color: ColorPicker.secondary }}
>
  👋 Hi, I&apos;m Sipu Rana, a passionate Software Development Engineer specializing in the MERN stack (MongoDB, Express.js, React.js, Node.js).
  I enjoy building scalable, secure, and user-focused web applications. I’ve worked on several real-time projects involving authentication systems,
  online transaction platforms, and product-based web apps. Currently, I’m expanding my expertise with Next.js to develop high-performance, SEO-friendly
  applications with modern UI/UX design principles.
</p>
</AOSWrapper>
